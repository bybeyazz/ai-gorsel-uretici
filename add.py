...
# Model yükleme (sadece ilk çalıştırmada)
@st.cache_resource
def load_model():
    with st.spinner("🧠 Model yükleniyor... (İlk kez uzun sürebilir)"):
...
with col1:
    st.header("✍️ Prompt")
    prompt = st.text_area("Görsel açıklaması:", 
                         "professional portrait photography, dramatic lighting, high quality",
                         height=150)
